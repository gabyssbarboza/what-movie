var moviesList = [
  ...
  },
  {
    ...
    "Poster": "https://images-na.ssl-images-amazon.com/images/M/MV5BMjMwMzM2MTg1M15BMl5BanBnXkFtZTcwNjM4ODY3Nw@@._V1_SX1777_CR0,0,1777,999_AL_.jpg",
    "Metascore": "69",
    "imdbRating": "8.1",
    "imdbVotes": "1,003,301",
    "imdbID": "tt0848228",
...
// var newValue = JSON.stringify(moviesList);
// var teste = JSON.parse(newValue)

// for(let i = 0; i<teste.length;i++){
//     console.log(`${teste[i].Title} ${teste[i].Type}`)
// }


var myBtn = document.getElementById('btn')

myBtn.addEventListener('click', myTeste)
var index = 0;
var indexDois = 0;

const mystart = document.getElementById('btn-start');
...
var moviePosters = document.querySelector('#movieCover');
moviePosters.src = moviesList[index].Poster;

const movieTituloCompleto = document.getElementById('titulos')
movieTituloCompleto.innerHTML = moviesList[index].Title;


var moviePlots = document.querySelector('#moviePlot');
moviePlots.innerText = moviesList[index].Plot;

var movieGenrer = document.querySelector('#movieGenrer');
movieGenrer.innerText = moviesList[index].Genre;
